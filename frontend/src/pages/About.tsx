  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-lime-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-14">
        <div className="bg-white rounded-2xl shadow-sm border border-orange-100 p-8 mb-10 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-14">
          {features.map((f) => (
            <div
              key={f.title}
              className="bg-white rounded-2xl border border-orange-100 shadow-sm p-6 flex flex-col gap-3 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
            >
